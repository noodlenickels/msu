    ...
    <MainBlock class = "flex h-lvh">
        ...
        <div class = " h-[100%] w-[100%]">
            <div class ="flex flex-row mt-[5px] ml-[5px]">
                ...
                <a href="" class = "flex text-center w-[120px] h-[48px] items-center justify-center bg-slate-300 rounded-sm border-2 ml-[3px] mr-[3px] border-neutral-600 "><span>Интервью</span></a>
