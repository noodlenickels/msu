    ...
    <div class=" h-[100%] w-[100%]">
      <div class="flex flex-row mt-[5px] ml-[5px]">
        <RouterLink to="/admin_panel/editor/news">
          <div
              class="flex text-center w-[120px] h-[48px] items-center justify-center bg-blue-300 rounded-sm border-2 ml-[3px] mr-[3px] border-blue-500">
            <span>Новости</span></div>
        </RouterLink>
        <RouterLink to="/admin_panel/editor/opinion">

          <div
              class="flex text-center w-[120px] h-[48px] items-center justify-center bg-slate-200 rounded-sm border-2 ml-[3px] mr-[3px] border-neutral-600">
      ...
      <div class = "flex flex-row mt-[10px] mb-[3px]">
        <RouterLink to="/admin_panel/editor/news/create">
        <div class = " flex text-[16px] w-[120px] rounded-md ml-[10px] items-center justify-center  h-[48px] bg-primary text-white"><span>Создать</span></div>
        </RouterLink>
        <RouterLink to="/admin_panel/editor/news/edit">
        <div class = " flex text-[16px] w-[120px] rounded-md ml-[5px] items-center justify-center  h-[48px] bg-primary text-white"><span>Изменить</span></div>
        </RouterLink>
        <div class = " flex text-[16px] w-[150px] rounded-md ml-[5px] items-center justify-center px-2 py-2 text-center h-[48px] bg-primary text-white"><span>Пометка на удаление</span></div>
        <div class = " flex text-[16px] w-[150px] rounded-md ml-[5px] items-center px-2 py-2 text-center justify-center  h-[48px] bg-primary text-white"><span>Выставить в первую полосу</span></div>
        <div class = " flex text-[16px] w-[120px] rounded-md ml-[5px] items-center justify-center  h-[48px] bg-primary text-white"><span>Экспорт</span></div>
      </div>
      <div class = 'flex'>
