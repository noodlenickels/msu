    ...
    <MainBlock class = "flex h-lvh">
        ...
        <div class = "h-[100%] w-[100%]">
            ...
            <div class = "flex flex-row ml-[260px] mt-[5px]">
                <a href="" class = "flex text-center w-[120px] h-[48px] items-center justify-center bg-blue-300 rounded-sm border-2 ml-[3px] mr-[3px]  border-blue-500"><span>Создание</span></a>
                </div>
