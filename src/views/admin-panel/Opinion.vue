    ...
    <div class=" h-[100%] w-[100%]">
      <div class="flex flex-row mt-[5px] ml-[5px]">
        ...
        <RouterLink to="/admin_panel/editor/opinion">
          <a href=""
             class="flex text-center w-[120px] h-[48px] items-center justify-center bg-blue-300 rounded-sm border-2 ml-[3px] mr-[3px] border-blue-500"><span>Мнения</span></a>
        </RouterLink>
        <RouterLink to="/admin_panel/editor/interview">
          <a href=""
             class="flex text-center w-[120px] h-[48px] items-center justify-center bg-slate-300 s rounded-sm border-2 ml-[3px] mr-[3px] border-neutral-600"><span>Интервью</span></a>
        </RouterLink>
      </div>
      ...
      <div class="flex flex-row mt-[10px] mb-[3px]">
        <RouterLink to="/admin_panel/editor/opinion/create">
          <div
        ...
        <RouterLink to="/admin_panel/editor/opinion/edit">
          <div
